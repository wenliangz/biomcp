...
6. Run `uv run pytest tests/test_mcp_contract.py -v --mcp-cmd "./target/release/biomcp serve"` when work touches MCP-facing behavior, docs, or startup expectations
